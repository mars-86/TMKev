...
#define TMKEV_GET_EVENT_STYPE(ev) ((ev & 0xFFFF0000) >> 16)
#define TMKEV_GET_MOUSE_BUTTON_STATUS(mb) (mb & 0x0000FFFF)
#define TMKEV_GET_CONTROL_KEY_STATUS(mb) ((mb & 0xFFFF0000) >> 16)
#define TMKEV_MOUSE_GET_X_COORD(coords) ((coords & 0xFFFF0000) >> 16)
#define TMKEV_MOUSE_GET_Y_COORD(coords) (coords & 0x0000FFFF)
